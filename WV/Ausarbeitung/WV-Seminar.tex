...
\cite{doncieux2015multi}\\
what research question is examined in the paper?\\
solution suggested by the paper\\
\bigskip
...
the framework - steps of application\\
\bigskip 

\section{Model analysis}
\label{sec:analysis}

usability - effort and benefits \\
applicability - assumptions and constraints made on the computational model, fields of application\\
\bigskip 
