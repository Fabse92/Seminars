...
\section*{Abstract}
The simulation of computational models is an increasingly popular method in science for knowledge generation about otherwise to complex systems.
If a point is reached at which the scientist can't foresee which parametrization of the model might lead to interesting behaviour, studying the model can become a tremendously time-consuming task. A framework method proposed by Doncieux et al. is able to generate in a partly automated way interesting model parameter values worth further studying.
