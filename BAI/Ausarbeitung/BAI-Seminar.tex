...
\newcommand{\trtitle}{On the Relationship between Generative Encodings .. - in-depth analysis}
...
\cite{citeulike:12788284}\\
what research question is examined in the paper?\\
Typical approaches\\
Solution by this paper
\bigskip

\section{related work}
\cite{hornby2001body}\\
\cite{mouret2010importing}\\
...
proposal - bias towards regularity is critical to evolve plastic neural networks\\
\bigskip 
...
\cite{yang2014sleep} - synaptic plasticity important for learning and memory\\
